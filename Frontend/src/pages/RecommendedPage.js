...
const RecommendedPage = () => {
  ...
  const getSortParameter = (sortOption) => {
    switch (sortOption) {
      ...
      case "oldest":
        return "createdAt"
      default:
        return "-views" // Default to popular for recommended
    }
  }
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        // Fetch recommended videos based on high view count and likes
        const videoResponse = await api.get("/videos", {
          params: {
            page: currentPage,
            limit: 64,
            sort: getSortParameter(sortOption),
            minViews: 1000, // Only show videos with at least 1000 views for recommendation
          },
        })
      ...
      <div className="home-header">
        <div className="home-title-section">
          ...
          <p className="home-subtitle">
            Curated content based on popularity and user engagement
          </p>
        </div>
