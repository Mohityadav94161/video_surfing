...
const TermsOfService = () => {
  return (
    <div style={{ maxWidth: '1000px', margin: '0 auto', padding: '40px 20px' }}>
      <Title level={1} style={{ textAlign: 'center', marginBottom: '20px' }}>Terms of Service</Title>
      ...
      <Card style={{ marginBottom: '30px' }}>
        <Title level={3}>5. Prohibited Uses</Title>
        <Paragraph>
      ...
      <Card style={{ marginBottom: '30px' }}>
        <Title level={3}>8. Revisions and Errata</Title>
        <Paragraph>
